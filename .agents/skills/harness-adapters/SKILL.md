...
description: >-
  ...
  Contains verified facts for claude, codex, opencode, pi, pi-signed, grok, kimi, cursor, gemini, muse, rovo, omp, agy, devin, and jcode.
...
```json harness-adapter-routing-v1
{
  ...
  "harnesses": {
    ...
    "jcode": "references/harness/jcode.md"
  }
}
```
